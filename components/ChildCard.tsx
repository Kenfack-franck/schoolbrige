...
export default function ChildCard({ child, colorIndex }: ChildCardProps) {
  ...
  return (
    <div
      className="bg-white border border-line rounded-2xl p-6 flex flex-col gap-5 transition-all duration-200 hover:-translate-y-0.5"
      style={{ boxShadow: "0 1px 6px rgba(0,0,0,0.06)", minWidth: 0 }}
